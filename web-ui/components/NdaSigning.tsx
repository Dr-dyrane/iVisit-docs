        ...
        <AnimatePresence>
            {isOpen && (
                <>
                    ...
                    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 lg:p-6 pointer-events-none">
                        <motion.div
                            initial={{ opacity: 0, y: 40, scale: 0.96 }}
                            animate={{ opacity: 1, y: 0, scale: 1 }}
                            exit={{ opacity: 0, y: 20, scale: 0.98 }}
                            transition={{ duration: 0.5, ease: [0.23, 1, 0.32, 1] }}
                            className="w-full max-w-[700px] max-h-[85vh]
                                     glass rounded-glass-xl flex flex-col overflow-hidden shadow-2xl pointer-events-auto"
                        >
                            {/* Header */}
